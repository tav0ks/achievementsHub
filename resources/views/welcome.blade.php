...
<head>
    ...
    <title>GameTrack - Sua Central de Jogos</title>
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-steamDark dark:text-white/50">
        <div
            class="relative min-h-screen flex flex-col items-center justify-center selection:bg-steamLight selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <a href="/">
                            <x-application-logo
                                class="font-alegrayaSc text-5xl text-center font-bold text-gray-800 dark:text-gray-200" />
                        </a>
                    </div>
                    @if (Route::has('login'))
                        <nav class="-mx-3 flex flex-1 justify-end">
                            @auth
                                <a href="{{ url('/dashboard') }}"
                                    class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-steamLight dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                                    Dashboard
                                </a>
                            @else
                                <a href="{{ route('login') }}"
                ...
                <main class="mt-6">
                    ...
                    <div class="text-center mb-16">
                        <h1 class="text-4xl font-bold text-black dark:text-white sm:text-5xl">
                            Centralize suas conquistas de jogos
                        </h1>
                    ...
                    <!-- Features Section -->
                    <div id="features" class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <!-- Steam Integration -->
                        <div class="relative flex items-center gap-6 lg:items-end">
                            <div
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-steamLight lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-steamLight">
                                <div class="flex items-start gap-6 lg:flex-col">
                                    <div
                                        class="flex size-12 shrink-0 items-center justify-center rounded-full bg-steamLight/50 sm:size-16">
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/8/83/Steam_icon_logo.svg"
                                            alt="Steam Logo" class="size-12">
                                    </div>
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white">Integração com
                                            Steam</h2>
                                        <p class="mt-4 text-sm/relaxed">
                                            Conecte sua conta da Steam e acompanhe suas conquistas, tempo de jogo e
                                            biblioteca de jogos.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-6 lg:flex-col">
                                    <div
                                        ...
                                        <img src="https://static.retroachievements.org/assets/images/ra-icon.webp"
                                            alt="RetroAchievements Logo" class="w-12 h-8">
                                    </div>
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white">RetroAchievements
                                        </h2>
                                        <p class="mt-4 text-sm/relaxed">
                                            Acompanhe suas conquistas em jogos retrô e veja seu progresso em consoles
                                            clássicos.
                                        </p>
                                    </div>
                                </div>
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    GameTrack &copy; {{ date('Y') }} - Todos os direitos reservados
                </footer>
            </div>
        </div>
    </div>
